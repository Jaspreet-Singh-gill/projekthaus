            ...
            <div>
                ...
                {!projects.isLoading && projects.data && (
                    projects.data.data.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-16 px-4 text-center rounded-2xl border border-dashed border-slate-900 bg-slate-950/20 max-w-lg mx-auto mt-8">
                            <div className="w-12 h-12 rounded-xl bg-slate-900 flex items-center justify-center text-slate-400 mb-4">
                            ...
                            <button
                                onClick={() => setOpen(true)}
                                className="mt-5 inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-semibold text-violet-400 hover:text-violet-300 transition-colors cursor-pointer"
                            >
                                Create a project
                            </button>
                        </div>
