...
} from "../../hooks/subtask/useSubtask.js";
...
const SubTaskDasboard = () => {
    ...
    const deleteMutation = useDeleteSubtask(projectId, taskId, subTaskId);
    const [openAssigned, setOpenAssigned] = useState(false);
    const mutationOfAssigned = assignSubtaskMember(projectId, taskId, subTaskId);
    const mutationDeleteTheMember = deleteSubtaskMember(projectId, taskId, subTaskId);
    const projectInfo = useGetTheProject(projectId, taskId, subTaskId);
    const assignedUpdationTask = useAssignedMemberSubtaskUpdation(projectId, taskId, subTaskId);

    const attachFileToTask = useAttachSubtaskFiles(projectId, taskId, subTaskId);
    const deleteFileFromTask = useDeleteSubtaskFile(projectId, taskId, subTaskId);
...
export default SubTaskDasboard;